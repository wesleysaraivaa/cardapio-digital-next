...
import type {
  CartItem,
  PaymentMethod as GlobalPaymentMethod,
} from "@/types/cart";
...
const OrderForm: React.FC<OrderFormProps> = ({
  ...
  const [paymentMethod, setPaymentMethod] =
    useState<GlobalPaymentMethod>("DINHEIRO");
  ...
  const isFormValid = () => {
    ...
    if (tipoPedido === "entrega" && (!phone.trim() || !address.trim()))
      return false;
    if (
  ...
  return (
    <form onSubmit={handleSubmitForm}>
      {" "}
      {/* Adicionado <form> para semântica e submit */}
      ...
      {paymentMethod === "PIX" && (
        <div className="mb-6 p-4 bg-gray-50 rounded-xl">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => navigator.clipboard.writeText("5511999999999")}
            ...
            <div className="mb-4 py-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={
                    paymentDetails.changeAmount !== null
                      ? paymentDetails.changeAmount.toString().replace(".", ",")
                      : ""
                  }
                ...
                paymentDetails.changeAmount >= total && (
                  <div className="mt-4 p-4 bg-gray-50 rounded-xl">
                    <p className="text-sm text-gray-600">
                      Troco para:{" "}
                      {paymentDetails.changeAmount.toLocaleString("pt-BR", {
                        style: "currency",
                        currency: "BRL",
                    ...
                    <p className="text-sm text-gray-600">
                      Valor do troco:{" "}
                      {(paymentDetails.changeAmount - total).toLocaleString(
                        "pt-BR",
                        {
                          style: "currency",
                          currency: "BRL",
